...
function Car(make, model, year, amountMoved){
  this.make = make;
  this.model = model;
  this.year = year;
...
Movie.prototype.changeRating = function(num) {
  var divide = this.rating + num 
  return this.rating = divide/2
}
...
User.prototype.removeSavedPost = function(id){
  var index = this.savedPosts.findIndex(post => post === id);
